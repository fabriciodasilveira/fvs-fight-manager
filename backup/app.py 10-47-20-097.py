...
class Aluno(db.Model):
    ...
    planos = db.relationship('Plano', secondary=aluno_plano, lazy='subquery',
...
def novo_plano():
    ...
    return render_template('planos/novo.html')
...
def editar_plano(id):
    ...
    if request.method == 'POST':
        ...
        return redirect(url_for('listar_planos'))
    return render_template('planos/novo.html', plano=plano)
